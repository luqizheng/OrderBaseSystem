...
namespace Orders.Quotations
{
    ...
    {
        public static QuotationServiceBuilder AddQuotationDapperStore(this QuotationServiceBuilder builder, string connectionString)
        {
            ...
            builder.Services.AddDbUow<QuotationUow>(() =>
            {
